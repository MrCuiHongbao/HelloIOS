...
@interface UISegmentProgressBar ()
...
@implementation UISegmentProgressBar

+ (UISegmentProgressBar *)getInstance
{
	UISegmentProgressBar *progressBar = [[UISegmentProgressBar alloc] initWithFrame:CGRectMake(0, 0, DEVICE_SIZE.width, BAR_H + BAR_MARGIN * 2)];
	return progressBar;
}
